...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.unreadCountResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.userAdminResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "internal_handlers.notificationListResponse": {
            ...
            "properties": {
                "notifications": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_handlers.notificationResponse"
                    }
                }
            }
        },
        "internal_handlers.notificationResponse": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
        ...
        "internal_handlers.unreadCountResponse": {
            "type": "object",
            "properties": {
                "count": {
                    "type": "integer"
        ...
        "internal_handlers.userAdminResponse": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
